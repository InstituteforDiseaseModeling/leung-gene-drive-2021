...
# ---- spatial, classic, GM only, EIR = 10 --> ALL DONE
...
# ---- spatial, integral, GM only, EIR = 10 --> ALL DONE
...
# ---- spatial, classic, VC and GM, EIR = 10 --> ALL DONE
...
# ---- spatial, integral, VC and GM, EIR = 10 --> ALL DONE
...
# ---- spatial, classic, GM only, EIR = 30 --> ALL DONE
# NOTE THAT THE 6 SWEEP VAR WORK ITEM DOESN'T HAVE ALLELE FREQS (EXP DOES)
...
# ---- spatial, integral, GM only, EIR = 30 --> ALL DONE
...
# ---- spatial, classic, VC and GM, EIR = 30 --> ALL DONE
...
# ---- spatial, integral, VC and GM, EIR = 30 --> ALL DONE
...
# ---- spatial, classic, VC and GM, EIR = 80 --> ALL DONE
# NOTE THAT THE 6 SWEEP VAR WORK ITEM DOESN'T HAVE ALLELE FREQS (EXP DOES)
...
# ---- spatial, integral, VC and GM, EIR = 80 --> ALL DONE
